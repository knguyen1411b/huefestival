    ...
    return (
        ...
        >
            <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                ...
                >
                    Năm Du lịch Quốc gia – Huế 2025 là sự kiện văn hóa, kinh tế và du lịch mang tầm quốc gia và quốc tế,
                    gắn liền với Festival Huế 2025 và các hoạt động chào mừng 50 năm Giải phóng thành phố Huế (26/3/1975
                    – 26/3/2025).
                </p>
