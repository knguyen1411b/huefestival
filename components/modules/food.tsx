            ...
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="my-5 text-base sm:text-lg md:text-xl text-center leading-relaxed text-white mali-font">
                        Ẩm thực Huế tinh tế và cầu kỳ, hòa quyện nét cung đình và dân gian. Món ăn không chỉ ngon mà còn
                        đẹp mắt, hài hòa về màu sắc, hương vị và nguyên liệu, thể hiện rõ bản sắc cố đô.
                    </p>
