...
export const CometCard = ({
  ...
  return (
    <div className={cn('perspective-distant transform-3d cursor-pointer', className)}>
      <motion.div
        ref={ref}
        ...
        style={{
          ...
          translateY,
          boxShadow:
            'rgba(0, 0, 0, 0.02) 0px 80px 60px 0px, rgba(0, 0, 0, 0.04) 0px 20px 40px 0px, rgba(0, 0, 0, 0.08) 0px 10px 20px 0px'
        }}
        initial={{ scale: 1, z: 0 }}
        whileHover={{
          scale: 1.05,
