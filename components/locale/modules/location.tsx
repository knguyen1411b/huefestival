...
const cards: Card[] = [
    ...
    },
    {
        ...
        thumbnail: '/images/location/3.webp',
        data: { lat: 16.4566559, lon: 107.5957013 }
    },
    {
        id: 4,
    ...
    },
    {
        ...
        thumbnail: '/images/location/5.webp',
        data: { lat: 16.4312012, lon: 107.5642039 }
    },
                ...
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="mt-3 sm:mt-4 mb-4 sm:mb-6 text-sm sm:text-base md:text-lg lg:text-xl text-white mali-font leading-relaxed drop-shadow-md">
                            Mentioning Hue brings to mind ancient architectural works and poetic, romantic natural
                            scenes within the peaceful, tranquil atmosphere of the old imperial city.
                        </p>
