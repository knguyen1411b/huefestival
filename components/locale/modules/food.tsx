            ...
            >
                ...
                <div className="flex flex-col justify-center items-center text-center mb-12">
                    ...
                    <p className="my-5 text-base sm:text-lg md:text-xl text-center leading-relaxed text-white mali-font">
                        Hue cuisine is delicate and sophisticated, blending royal court and folk flavors. The dishes are
                        not only delicious but also visually appealing, harmonizing colors, tastes, and ingredients,
                        clearly reflecting the identity of the ancient capital.
                    </p>
