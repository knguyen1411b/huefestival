    ...
    return (
        ...
        >
            <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                ...
                >
                    The National Tourism Year – Hue 2025 is a cultural, economic, and tourism event of national and
                    international significance, held in conjunction with the Hue Festival 2025 and activities
                    celebrating the 50th anniversary of the Liberation of Hue City (March 26, 1975 – March 26, 2025).
                </p>
