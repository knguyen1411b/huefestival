                ...
                {[
                    ...
                    <div key={idx} className="relative h-[150px] lg:h-[200px] w-full overflow-hidden">
                        ...
                        <div
                            ...
                            data-aos="fade-in"
                        >
                            {[{ text: 'LANG' }, { text: 'NGHE' }, { text: 'TRUYEN' }, { text: 'THONG' }].map(
                                (sub, subIdx) => (
                                    <ShinyText
                                        text={sub.text}
                                        speed={3}
                ...
                {craftVillages.map(({ title, description, imgSrc }, idx) => {
                    ...
                    return (
                        <div
                            key={title}
                            className={cn(
                                'flex lg:flex-row items-center gap-12 mb-8',
                                ...
                                <>
                                    ...
                                    <div className="flex-1" data-aos="fade-left" data-aos-duration="1000">
                                        <div className="text-center space-y-6">
                                            <h3 className="text-3xl font-extrabold text-red-700 rowdies-font drop-shadow-md">
                                                {title}
                                            </h3>
