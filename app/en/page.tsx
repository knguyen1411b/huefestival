...
import ScrollToTop from '@/components/locale/ui/scroll-to-top'
import ReactLenis from 'lenis/react'
import Section from '@/components/locale/layouts/section'
import Navbar from '@/components/locale/layouts/navbar'
import HomeSection from '@/components/locale/modules/home'
import IntroSection from '@/components/locale/modules/intro'
import FoodSection from '@/components/locale/modules/food'
import CraftVillageSection from '@/components/locale/modules/village'
import Footer from '@/components/locale/layouts/footer'
import ArtSection from '@/components/locale/modules/art'
import LocationSection from '@/components/locale/modules/location'
